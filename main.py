...
if __name__ == '__main__':
    ...
    print('Canny ...')
    canny = Canny(Guassian_kernal_size, img_gray, HT_high_threshold, HT_low_threshold,Save_Path)
    #cv2.imwrite(Save_Path + "canny_original.jpg", canny.img)
    ...
    for circle in circles:
        cv2.circle(img_RGB, (math.ceil(circle[0]), math.ceil(circle[1])), math.ceil(circle[2]), (0, 0, 255), 4)
